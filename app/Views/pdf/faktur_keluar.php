<?php
$docTitle = 'Faktur Barang Keluar';
$docRef   = $header['no_transaksi'] ?? '';
$pdfMeta ??= [];
$pdfMeta['doc_ref'] = $docRef;

$tgl = $header['tanggal_keluar'] ?? '';
...
<table class="pdf-meta-table">
    <tr>
        ...
        <td class="val"><?= esc($header['no_transaksi'] ?? '-') ?></td>
        <td class="lbl">Tanggal</td>
        <td class="val"><?= esc($tgl) ?></td>
    </tr>
    <tr>
        <td class="lbl">Tujuan</td>
        <td class="val"><?= esc($header['tujuan'] ?? '-') ?></td>
